...
class PaymongoService {
  ...
  /// The buyer's app intercepts these URLs in the WebView. They never need
  /// to be reachable — PayMongo just requires valid HTTPS URLs.
  static const String successUrl = 'https://quickcart.app/payment/success';
  static const String failedUrl = 'https://quickcart.app/payment/failed';
